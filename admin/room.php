                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-bs-toggle="tooltip" title="Edit Task" class="btn btn-link btn-primary btn-lg" onclick="openEditRoomModal('<?php echo $room['RoomID']; ?>', '<?php echo $room['RoomName']; ?>', '<?php echo $room['Image']; ?>', '<?php echo $room['Type']; ?>', '<?php echo $room['Capacity']; ?>', '<?php echo $room['Price']; ?>', '<?php echo $room['Description']; ?>', '<?php echo $room['NumberBed']; ?>', '<?php echo $room['TypeBed']; ?>', '<?php echo $room['Quantity']; ?>', '<?php echo $room['Disponibility']; ?>')">
